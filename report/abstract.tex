...
%  work we are describing in this report, and what our results are.
  ...
  simulator. We discover that the applications the prefetcher is
  operating on is paramount to its performance, and make a case for
  the validity of selecting a tailor-made prefetcher for special
  workloads.
